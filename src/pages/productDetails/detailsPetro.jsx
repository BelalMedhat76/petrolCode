...
const DetailsPetro = () => {
  const {id}=useParams();
 const [ categoryPetro, setcategoryPetro] = useState([]);
...
{ categoryPetro && (
      ...
      <div className="productDetails container">
        <div className="productLeft container">
          <h1 style={{color:"#0773df" ,fontWeight:"bold"}}>{categoryPetro.title}</h1>
          <p style={{fontWeight:"bold",fontSize:"20px"}}>{categoryPetro.name}</p>
          <p style={{fontWeight:"bold",fontSize:"20px"}}>SAE 5W-40 API SN/CF </p>
          <p style={{marginBottom:"50px"}}>
            {categoryPetro.description}
          </p>
          <div classNameName="" >
        ...
        <div className="productRight">
          <img src={categoryPetro.img} alt="" className="ProductDetails_Img" />
        </div>
      </div>
      )}
    </div>
