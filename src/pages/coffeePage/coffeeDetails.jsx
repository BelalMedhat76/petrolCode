...
{ categoryCoffee && (
      ...
      <div className="productDetails container">
        <div className="productLeft container">
          <h1 style={{color:"#0773df" ,fontWeight:"bold"}}>Nice Coffee</h1>
          <p style={{fontWeight:"bold",fontSize:"20px"}}>{categoryCoffee.productName}</p>
          <p style={{fontWeight:"",fontSize:"18px"}}> <span style={{fontWeight:"bold" ,color:"#0773df"}}>Description :  </span> {categoryCoffee.desc} </p>
          <p style={{marginBottom:"50px"}}>
            {categoryCoffee.description}
          </p>
        ...
        <div className="productRight">
          <img src={categoryCoffee.img} alt="" className="ProductDetails_Img" />
        </div>
      </div>
      )}
    </div>
