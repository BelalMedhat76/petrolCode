...
{categoryContex.length > 0 && categoryContex.map(product=>(
  
        <Link  to={`/productdetails/${product.id}`} data-menu={product.data} className="single news-Slide-up" id="cardHover" key={product.id} >
